...
from notifications.emailDispatcher import send_assessment_link
from auth.authorization import require_permission
from audit.logger import log_audit
from fastapi import Request
from infrastructure.tenantAwareRepository import assessment_session_repo, patient_repo
...
async def update_status(session_id: str, status_data: dict, request: Request, current_user = Depends(require_permission("update_assessment_session"))):
    ...
    from infrastructure.state_machine import validate_assessment_session_transition
