...
from src.infrastructure.telemetry.request_context import get_user_role, get_tenant_id, get_user_id, get_ip_address
...
class BaseRepository:
    ...
    async def _audit_log(self, action: str, before_state: Optional[Dict], after_state: Optional[Dict], changes: Optional[Dict], resource_id: str):
        ...
        """
        from src.infrastructure.telemetry.request_context import get_tenant_id, get_user_id, get_ip_address
...
class TenantAwareRepository(BaseRepository):
    ...
    async def create(self, tenant_id: str, data: Dict[str, Any], tx: Optional[Any] = None, **kwargs):
        ...
        # Inject tenant_id into create data if not present
