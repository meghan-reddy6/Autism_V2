...
async def get_dashboard_stats(
    current_user: Any = Depends(require_roles(["SUPER_ADMIN", "CLINIC_ADMIN", "ORG_ADMIN", "DOCTOR", "PSYCHOLOGIST", "THERAPIST", "RECEPTIONIST"]))
):
    tenant_id = current_user.tenantId
    from src.repositories.tenant_aware_repository import patient_repo, assessment_session_repo, assessment_repo, appointment_repo
