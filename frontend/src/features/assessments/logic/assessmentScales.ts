export const SCALES = {
  ...
  "ISAA": {
    name: "ISAA",
    questions: [
      { id: "isaa_1", label: "1. Has poor eye contact" },
      { id: "isaa_2", label: "2. Lacks social smile" },
      { id: "isaa_3", label: "3. Remains aloof" },
      { id: "isaa_4", label: "4. Does not reach out to others" },
      { id: "isaa_5", label: "5. Unable to relate to people" },
      { id: "isaa_6", label: "6. Unable to respond to social/environmental cues" },
      { id: "isaa_7", label: "7. Engages in solitary play" },
      { id: "isaa_8", label: "8. Unable to take turns in social interaction" },
      { id: "isaa_9", label: "9. Does not share joys" },
      { id: "isaa_10", label: "10. Shows inappropriate emotional response" },
      { id: "isaa_11", label: "11. Shows exaggerated emotions" },
      { id: "isaa_12", label: "12. Engages in self-stimulating emotions" },
      { id: "isaa_13", label: "13. Lacks fear of danger" },
      { id: "isaa_14", label: "14. Excited or agitated for no apparent reason" },
      { id: "isaa_15", label: "15. Acquired speech and lost it" },
      { id: "isaa_16", label: "16. Has difficulty in using non-verbal language or gestures" },
      { id: "isaa_17", label: "17. Engages in stereotyped and repetitive use of language" },
      { id: "isaa_18", label: "18. Engages in echolalic speech" },
      { id: "isaa_19", label: "19. Does not engage in reciprocal communication" },
      { id: "isaa_20", label: "20. Unable to initiate or sustain conversation" },
      { id: "isaa_21", label: "21. Uses jargon or meaningless words" },
      { id: "isaa_22", label: "22. Uses pronoun reversals" },
      { id: "isaa_23", label: "23. Unable to grasp pragmatics of communication" },
      { id: "isaa_24", label: "24. Engages in stereotyped and repetitive motor mannerisms" },
      { id: "isaa_25", label: "25. Shows attachment to inanimate objects" },
      { id: "isaa_26", label: "26. Shows hyperactivity/restlessness" },
      { id: "isaa_27", label: "27. Exhibits aggressive behavior" },
      { id: "isaa_28", label: "28. Throws temper tantrums" },
      { id: "isaa_29", label: "29. Engages in self-injurious behavior" },
      { id: "isaa_30", label: "30. Insists on sameness" },
      { id: "isaa_31", label: "31. Unusually sensitive to sensory stimuli" },
      { id: "isaa_32", label: "32. Stares into space for long periods" },
      { id: "isaa_33", label: "33. Has difficulty in tracking objects" },
      { id: "isaa_34", label: "34. Has unusual vision" },
      { id: "isaa_35", label: "35. Insensitive to pain" },
      { id: "isaa_36", label: "36. Responds to objects/people unusually" },
      { id: "isaa_37", label: "37. Inconsistent attention and concentration" },
      { id: "isaa_38", label: "38. Shows delay in responding" },
      { id: "isaa_39", label: "39. Has unusual memory" },
      { id: "isaa_40", label: "40. Has savant ability" }
    ]
  }
};
